...
(
    ...
    -- the time it took to receive the first byte (time to first byte - ttfb) in milliseconds
    ipfs_cat_ttfb_ms         Int32,
    -- the total time it took to download the file in milliseconds
    ...
    -- the duration of the IPNI query in milliseconds
