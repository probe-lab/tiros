...
TIROS_RUN_KUBO_HOST_IP=ipfs # necessary so that the chrome container can access kubo
TIROS_RUN_KUBO_HOST_NAME=helia # necessary so that the chrome container can access kubo
